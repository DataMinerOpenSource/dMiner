...
public class FractionalLinearOrdinaryLeastSquaresTest {
    ...
    @Test
    public void testRegressStrongFractionalLinearFunction() {
        // y = 1 / (2x + 4)
        ...
        Assert.assertEquals(2.0, results.getCoefficientA(), 0.0000001);
        Assert.assertEquals(4.0, results.getCoefficientB(), 0.0000001);
        Assert.assertTrue(Math.abs(results.getCorrelationCoefficient()) > 0.7);
        Assert.assertEquals(1.7134581017857065E-10, results.getRootMeanSquaredError(), Double.MIN_NORMAL);
