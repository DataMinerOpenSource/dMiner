...
public class RationalOrdinaryLeastSquaresTest {
    @Test
    public void testRegressStrongRationalFunction() {
        // y = x / (2x + 2)
        ...
        final OrdinaryLeastSquares osl = new RationalOrdinaryLeastSquares();
        ...
        Assert.assertEquals(2.0, results.getCoefficientA(), 0.00000001);
        Assert.assertEquals(2.0, results.getCoefficientB(), 0.00000001);
        Assert.assertTrue(results.getCorrelationCoefficient() > 0.7);
        Assert.assertEquals(2.034114892823078E-10, results.getRootMeanSquaredError(), Double.MIN_NORMAL);
